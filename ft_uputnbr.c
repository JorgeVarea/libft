...
/*   Updated: 2023/11/14 22:23:50 by jorvarea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static void	ft_secure_putchar(char c, int *total_bytes_written, int *error)
{
	int	bytes_written;
...
static void	ft_write_number(unsigned int n, int *total_bytes_written, int *error)
{
	char	str[12];
	int		i;
